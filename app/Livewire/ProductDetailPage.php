...
class ProductDetailPage extends Component
{
    ...
    {
        if (Auth::check()) {
            $this->likedProducts = LikedProductManagement::showLiked(); // Get liked product IDs
        }
    ...
    public function addToLiked($productId)
    {
        ...
        if (isset($result['error'])) {
            ...
            if (in_array($productId, $this->likedProducts)) {
                $this->likedProducts = array_diff($this->likedProducts, [$productId]); 
            } else {
