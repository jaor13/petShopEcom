...
<div class="container mx-auto px-4">
      ...
      <div class="md:w-3/4 mb-4">
        <div>
          <div class="flex justify-between items-center mb-2 bg-white overflow-x-auto rounded-md py-2 px-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-4 mr-4 pt-1 " viewBox="0 0 24 24" fill="none"
    ...
    @endforelse
      ...
      <div class="md:w-1/4">
        ...
        class="bg-[#00DCE3] font-semibold text-white block text-center py-2 px-4 rounded-md mt-4 w-full">
        Checkout
        </button>
      @endif
      </div>
