...
<div class="container mx-auto px-4">
    <h1 class="text-2xl font-semibold mb-2">Shopping Cart</h1>
      ...
      <div class="md:w-3/4 mb-4">
        <div>
          ...
          <div class="bg-white overflow-x-auto rounded-md shadow-md p-10">
            ...
            <thead>
              <tr>
              <th class="text-left font-semibold">Products</th>
                <th></th>
                ...
                <th class="text-center font-semibold" style="width: 50px;">Action</th>
                </tr>
            </thead>
            <tr>
              <td colspan="6">
