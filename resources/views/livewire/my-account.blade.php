                ...
                <div style="margin-bottom: 50px;">
                    ...
                    @if (Auth::user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !Auth::user()->hasVerifiedEmail())
                        <div class="alert alert-warning mt-3">
                            ...
                            <button wire:click="sendVerificationEmail" class="btn btn-link">Click here to re-send the
                                verification
                                email.</button>
                        </div>
                    ...
                    <div style="margin-bottom: 50px;">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="form-check me-3">
                                        <input type="radio" wire:model="gender" value="male" class="form-check-input"
                                            id="maleRadio">
                                        <label class="form-check-label" for="maleRadio">Male</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" wire:model="gender" value="female" class="form-check-input"
                                            id="femaleRadio">
