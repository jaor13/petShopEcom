<div class="container">
    <div class="row">
        <div class="col-md-12 px-5 py-3 mt-2 rounded shadow-sm custom-card-design">
            ...
            <form>
                <div class="mb-3">
                    <label for="usernameReadonly" class="form-label">Name</label>
                    <input type="text" class="form-control" id="usernameReadonly" value="{{ $username ?? '' }}" readonly>
                </div>

                <div class="mb-3">
                    <label for="dobReadonly" class="form-label">Date of Birth</label>
                    <input type="date" class="form-control" id="dobReadonly" value="{{ $dob ?? '' }}" readonly>
                </div>

                <div class="mb-3">
                    <label class="form-label">Gender</label>
                    <div>
                        <input type="radio" id="maleReadonly" value="male" {{ ($gender ?? '') === 'male' ? 'checked' : '' }} disabled> <label for="maleReadonly">Male</label>
                ...
                <div class="mb-3">
                    <label for="phoneReadonly" class="form-label">Phone Number</label>
                    <input type="text" class="form-control" id="phoneReadonly" value="{{ $phone ?? '' }}" readonly>
                </div>
