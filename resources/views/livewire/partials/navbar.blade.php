            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <button @click="open = !open" @click.away="open = false"
                    ...
                    @auth
                        ...
                        <div class="w-9 h-9 rounded-full overflow-hidden shadow-md shadow-gray-300 flex items-center justify-center ml-4 mb-2">
                        ...
                        @else
                            <i class="fa-solid fa-user-circle iconify-user"
