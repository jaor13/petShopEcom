<div class= row> 
    <nav id="sidebar" class="col-md-4 col-lg-3 d-md-block bg-light sidebar" style="height: 500px;"> 
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a wire:click.prevent="setActiveSection('my-account')" class="nav-link {{ $activeSection === 'my-account' ? 'active' : '' }}" href="#" style="color: gray;">
                        <i class="fas fa-user" style="color: gray;"></i> My Account
                    </a>
                </li>
                <li class="nav-item">
                    <a wire:click.prevent="setActiveSection('my-purchases')" class="nav-link {{ $activeSection === 'my-purchases' ? 'active' : '' }}" href="#" style="color: gray;">
                        <i class="fas fa-history" style="color: gray;"></i> My Purchases
                    </a>
                </li>
                <li class="nav-item ">
                    <a wire:click.prevent="setActiveSection('ratings-reviews')" class="nav-link {{ $activeSection === 'ratings-reviews' ? 'active' : '' }}" href="#" style="color: gray;">
                        <i class="fas fa-star" style="color: gray;"></i> Ratings and Reviews
                    </a>
                </li>
                <li class="nav-item">
                    <a wire:click.prevent="setActiveSection('liked-products')" class="nav-link {{ $activeSection === 'liked-products' ? 'active' : '' }}" href="#" style="color: gray;">
                        <i class="fas fa-heart" style="color: gray;"></i> Liked Products
                    </a>
                </li>
            </ul>
        </div>
